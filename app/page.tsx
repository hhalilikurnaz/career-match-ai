...
import { CVAnalysisImportance } from './components/cv-analysis-importance'
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-professor-gray-100"> {/* Arka plan rengi güncellendi */}
      <Navbar />
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center relative">
          ...
          <div className="absolute top-20 right-20 w-16 h-16 bg-professor-gold-200 rounded-full opacity-20 animate-bounce" style={{animationDelay: '1s'}}></div>
          <div className="absolute bottom-10 left-20 w-12 h-12 bg-professor-blue-300 rounded-full opacity-20 animate-bounce" style={{animationDelay: '2s'}}></div>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border-professor-gray-200 bg-white/80 backdrop-blur-sm">
              <CardContent className="pt-8 pb-8 text-center">
                ...
                <h3 className="text-xl font-semibold mb-3 text-professor-gray-900">
                  {t('uploadCV')}
                </h3>
                <p className="text-professor-gray-600 leading-relaxed">
                  CV'nizi yükleyin ve AI ile analiz ettirin
                </p>
              </CardContent>
            </Card>

            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border-professor-gray-200 bg-white/80 backdrop-blur-sm" style={{animationDelay: '0.2s'}}>
              <CardContent className="pt-8 pb-8 text-center">
                ...
                <p className="text-professor-gray-600 leading-relaxed">
                  İş ilanları ile uyumluluk analizi yapın
                </p>
              </CardContent>
            </Card>

            <Card className="group hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border-professor-gray-200 bg-white/80 backdrop-blur-sm" style={{animationDelay: '0.4s'}}>
              <CardContent className="pt-8 pb-8 text-center">
                ...
                <p className="text-professor-gray-600 leading-relaxed">
                  Kişiselleştirilmiş geliştirme önerileri alın
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      {/* CV Analysis Importance Section (New) */}
      ...
      {/* CTA Section */}
      <section className="py-20 bg-professor-gray-900"> {/* Arka plan rengi güncellendi */}
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
            Kariyerinizi Bugün Güçlendirin
          </h2>
