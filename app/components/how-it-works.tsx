  ...
  const steps = [
    {
      ...
      title: t('uploadCV'),
      description: t('uploadCVDescription'), // New translation key
      step: '01'
    },
    {
      icon: <Brain className="h-8 w-8" />,
      title: t('aiAnalysis'), // New translation key
      description: t('aiAnalysisDescription'), // New translation key
      step: '02'
    },
    {
      icon: <Target className="h-8 w-8" />,
      title: t('compatibilityScore'),
      description: t('compatibilityScoreDescription'), // New translation key
      step: '03'
    },
    {
      icon: <MessageSquare className="h-8 w-8" />,
      title: t('personalSuggestions'), // New translation key
      description: t('personalSuggestionsDescription'), // New translation key
      step: '04'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-professor-gray-600 max-w-2xl mx-auto">
            {t('howItWorksSubtitle')} {/* New translation key */}
          </p>
        </div>
                ...
                <CardContent className="p-8 text-center">
                  ...
                  <div className="mt-8 mb-6">
                    <div className="w-16 h-16 bg-professor-blue-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                      <div className="text-professor-blue-600">
                        {step.icon}
                      </div>
                    </div>
                    <h3 className="text-xl font-semibold text-professor-gray-900 mb-3">
                      {step.title}
                    </h3>
